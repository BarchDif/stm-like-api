...
/*
Package stm_like_api is a reverse proxy.
...
func RegisterOmpTemplateApiServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OmpTemplateApiServiceServer) error {
	...
	mux.Handle("GET", pattern_OmpTemplateApiService_DescribeTemplateV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ozonmp.stm_like_api.v1.OmpTemplateApiService/DescribeTemplateV1", runtime.WithHTTPPathPattern("/v1/templates/{template_id}"))
		if err != nil {
...
func RegisterOmpTemplateApiServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OmpTemplateApiServiceClient) error {
	...
	mux.Handle("GET", pattern_OmpTemplateApiService_DescribeTemplateV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ozonmp.stm_like_api.v1.OmpTemplateApiService/DescribeTemplateV1", runtime.WithHTTPPathPattern("/v1/templates/{template_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
